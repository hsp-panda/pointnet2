...
#/home/vcortex/anaconda3/envs/tensorflow/lib/python3.7/site-packages/tensorflow_core/libtensorflow_framework.so.1
...
g++ -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I $TF_INC -I /usr/include -I $TF_INC/external/nsync/public -lcudart -L /usr/lib/cuda/lib64/ -L$TF_LIB -ltensorflow_framework  -O2 -D_GLIBCXX_USE_CXX11_ABI=0
